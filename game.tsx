...
const gameObjects: GameObject[] = [
  // Tier 1 (0-2cm)
  { type: 'paperclip', size: 0.2, model: 'models/paperclip.glb', position: [1, 0, 1], rotation: [0, 0, 0], scale: 1, color: '#A1A1A1', sound: 'music/blips/01.mp3' },
  ...
  { type: 'spoon', size: 2, model: 'models/spoon.glb', position: [3, 0, 3], rotation: [0, 0, 0], scale: 1, color: '#9E9E9E', sound: 'music/blips/05.mp3' },
        ...
        if (object.parent === scene) {
          ...
          if (distance < combinedRadius) {
            if (
              ...
              // object.scale.multiplyScalar(0.9); // scale
